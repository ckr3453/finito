...
mixin _$CategoryEntity {
 ...
 String get id; String get name; int get colorValue; String get iconName; int get sortOrder; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,colorValue,iconName,sortOrder,createdAt,updatedAt);

@override
String toString() {
  return 'CategoryEntity(id: $id, name: $name, colorValue: $colorValue, iconName: $iconName, sortOrder: $sortOrder, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, int colorValue, String iconName, int sortOrder, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of CategoryEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? colorValue = null,Object? iconName = null,Object? sortOrder = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  int colorValue,  String iconName,  int sortOrder,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.id,_that.name,_that.colorValue,_that.iconName,_that.sortOrder,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  int colorValue,  String iconName,  int sortOrder,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity():
return $default(_that.id,_that.name,_that.colorValue,_that.iconName,_that.sortOrder,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  int colorValue,  String iconName,  int sortOrder,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _CategoryEntity() when $default != null:
return $default(_that.id,_that.name,_that.colorValue,_that.iconName,_that.sortOrder,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _CategoryEntity implements CategoryEntity {
  const _CategoryEntity({required this.id, required this.name, required this.colorValue, this.iconName = 'folder', this.sortOrder = 0, required this.createdAt, required this.updatedAt});
...
/// Create a copy of CategoryEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? colorValue = null,Object? iconName = null,Object? sortOrder = null,Object? createdAt = null,Object? updatedAt = null,}) {
